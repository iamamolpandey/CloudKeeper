-- 2. For all region get Data Transfer Costs on a daily basis, separate file per region = dt_costs

SELECT 

product_servicecode, 

-- If want to see service wise Data Transfer
...
product_servicecode = 'AWSDataTransfer'
